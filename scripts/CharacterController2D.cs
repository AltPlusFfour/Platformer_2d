	...
	void CollisionCheck()
		{
			...
			if (Plus.isWallDetected = Physics2D.Raycast(Plus.wallCheck.position, Vector2.right, Plus.wallCheckDist, m_WhatIsGround))
			{
				Plus.isWallDetected = true;
			}

			if (Plus.isWallDetected == true)
			{
